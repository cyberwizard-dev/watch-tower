            ...
            <PageHeader
                title={
                    <span className="flex flex-col gap-1">
                        <span className="text-xs font-normal tracking-wider text-muted-foreground uppercase">Notifications</span>
                ...
                breadcrumbs={[
                    { label: 'Activity' },
                    { label: 'Notifications', href: notificationsRoutes.index(slug).url },
                    { label: 'Detail' },
                ]}
