                                                            ...
                                                            <div className="grid gap-6 text-left md:grid-cols-2">
                                                                ...
                                                                <div className="space-y-3">
                                                                    ...
                                                                    <div className="space-y-2 rounded-md border border-border/40 bg-background p-3">
                                                                        <div className="py-0.5 text-xs">
                                                                            ...
                                                                            <span className="leading-relaxed font-semibold text-foreground select-all">
                                                                                {send.from_name
                                                                        ...
                                                                        <div className="border-t border-border/10 py-0.5 pt-2 text-xs">
                                                                            <span className="block text-[10px] font-medium text-muted-foreground uppercase">
                                                                                To
                                                                                (Recipients):
                                                                            </span>
                                                                            <span className="font-mono text-[11px] leading-normal break-all whitespace-pre-wrap text-foreground select-all">
                                                                                {Array.isArray(
                                                                                    send.recipients_to,
                                                                                )
                                                                                    ? send.recipients_to.join(
                                                                                          ', ',
                                                                                      )
                                                                                    : String(
                                                                                          send.recipients_to ??
                                                                        ...
                                                                        {send.recipients_cc &&
                                                                            send
                                                                                ...
                                                                                <div className="border-t border-border/10 py-0.5 pt-2 text-xs">
                                                                                    ...
                                                                                    <span className="font-mono text-[11px] break-all text-foreground select-all">
                                                                                        {send.recipients_cc.join(
                                                                                            ', ',
                                                                                        )}
                                                                                    </span>
                                                                                </div>
                                                                ...
                                                                {send.body ? (
                                                                    <div className="col-span-2 mt-4 space-y-3">
                                                                        ...
                                                                        <div className="overflow-hidden rounded-md border border-border/40 bg-white p-2">
                                                                            <iframe
                                                                                srcDoc={
                                                                                    send.body
                                                                                }
