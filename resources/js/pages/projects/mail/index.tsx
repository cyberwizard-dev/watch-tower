...
export default function MailIndex({
    ...
    return (
        <AppLayout title="Mail">
            <PageHeader
                title="Mail"
                breadcrumbs={[{ label: 'Activity' }, { label: 'Mail' }]}
        ...
        <TableRow className="cursor-pointer hover:bg-muted/50">
            <TableCell className="py-2.5">
                <div className="flex items-start gap-2.5">
                    ...
                    >
                        <span
                            className="block max-w-[640px] truncate text-sm font-semibold text-foreground"
                            title={row.mailable_class}
                        >
                            {row.mailable_class.split('\\').pop() ??
                                row.mailable_class}
                        </span>
                        <span
                            className="block max-w-[640px] truncate font-mono text-[11px] leading-tight text-muted-foreground/80"
                            title={row.mailable_class}
                        >
                            {row.mailable_class}
                        </span>
                        {(row.last_subject || row.last_from_name) && (
                            <span className="mt-1 block max-w-[640px] truncate text-xs leading-normal text-muted-foreground/90">
                                Subject:{' '}
